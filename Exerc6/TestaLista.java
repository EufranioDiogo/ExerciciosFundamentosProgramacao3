public class TestaLista {
    ...
    public static void removerAlunosComUmCertaIdade(TestaLista listaDeAlunos, int idadeAlvo) {
        if(listaDeAlunos.primeiroAluno != null) {
            Aluno alunoAux = listaDeAlunos.primeiroAluno;

            while(alunoAux != null) {
                if (alunoAux.idade == idadeAlvo) {
                    listaDeAlunos.removerAlunoRegistrado(alunoAux.matricula);
                }
                alunoAux = alunoAux.nextAluno;
            }
        }
